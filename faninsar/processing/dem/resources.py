# ruff: noqa: D105, E501, EM101, EM102, TRY003
...
class ResourceBudget:
    ...
    def __post_init__(self) -> None:
        for name in ("max_cells", "max_output_bytes", "max_fetch_bytes", "max_temporary_bytes"):
...
__all__ = ["ResourceBudget", "ResourcePreflightError", "preflight_grid", "preflight_transfer"]
