...
if TYPE_CHECKING:
    ...
    from faninsar.processing.geometry.providers import _P0030Source
    from faninsar.processing.geometry.resources import ResourceBudget
...
def _sample_dataset(
    ...
    *,
    ...
    from faninsar.processing.geometry.api import _sample_biquintic
...
def _materialize_entry(
    ...
    *,
    ...
    from faninsar.processing.geometry.api import RasterDEM
    from faninsar.processing.geometry.dem_sources import (
        DeferredGranulePlan,
        DeferredStacPlan,
    )
