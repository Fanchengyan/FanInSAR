...
from faninsar.processing.mosaicking.overlap import compute_hanning_weight
...
def _align_global_const(
    ...
    *,
    ...
    """
    from faninsar.processing.mosaicking.phase_network import solve_network
...
def _align_insardev(
    ...
    *,
    ...
    """
    from faninsar.processing.mosaicking.phase_network import MergeGraphStats
...
def _combine(
    ...
    *,
    ...
    always ``p.weight``).
    """
    from faninsar.processing.mosaicking.products import MosaicProduct
