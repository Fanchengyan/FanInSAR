...
from faninsar.processing.geometry.resources import ResourceBudget, preflight_transfer
...
def _response_metadata(
    response: object,
) -> tuple[int | None, int | None, Mapping[str, str]]:
...
def stream_to_cache(
    ...
    *,
    ...
    if expected_length is not None:
        preflight_transfer(
            expected_length, budget=ResourceBudget(max_fetch_bytes=max_bytes)
        )
