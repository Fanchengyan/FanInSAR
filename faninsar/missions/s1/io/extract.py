...
delegate to :func:`faninsar.missions.s1.io.read.read_full_burst`, so
...
def _measurement_zip_member(swath: S1Swath) -> tuple[Path, str] | None:
    ...
    # /vsizip//<zip_path>/<member>  produced by faninsar.missions.s1.safe
...
def extract_burst(swath: S1Swath, *, burst_index: int = 0) -> BurstArray:
    ...
    Examples
    --------
    >>> from faninsar.missions.s1 import open_safe_product, extract_burst
    ...
    from faninsar.missions.s1.io.read import read_full_burst
