...
Usage example::
    ...
    from faninsar.missions.sentinel1.io.remote import RemoteSafe
    ...
    from faninsar.missions.sentinel1.io.remote import extract_remote_burst
...
class RemoteSafe:
    ...
    def extract_burst(
        ...
        BurstArray
            ...
            convention of :func:`~faninsar.missions.sentinel1.io.read.read_full_burst`.
