"""Tests for the production S1 full-burst pair workflow."""
...
from faninsar.processing.geometry import ConstantDEM, PreparedGeometryArrayPayload
...
def test_stage_coregister_can_use_geometry_offsets_without_empirical_shift(
    ...
    import faninsar.missions.s1.processing as production_mod
...
def test_geo_topographic_phase_preserves_row_order_when_chunked(
    ...
    from faninsar.missions.s1 import processing as production
    from faninsar.processing.coregistration.offsets import OffsetFieldResult
    from faninsar.processing.geocoding.geo_lut import Geo2RdrLUT
    from faninsar.processing.mosaicking.grid import GeoGridSpec
