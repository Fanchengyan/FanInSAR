"""Frame.to_ifg_stack seam producer tests (synthetic stack path)."""
...
def test_stack_round_trip_inverse() -> None:
    """Synthetic InterferogramStack inverts without Frame coupling."""
    names = [
        "20170111_20170204",
        "20170111_20170222",
        "20170204_20170222",
...
def test_solver_source_has_no_frame_import() -> None:
    ...
    # Frame may appear only in comments; ensure no constructor of Frame
