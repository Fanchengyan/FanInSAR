...
def test_ncc_registry_requires_exact_abi_and_shape(
    ...
    from faninsar.processing.coregistration import ampcor_backend
...
def test_native_preparation_rejects_source_abi_mismatch(
    ...
    from faninsar.processing.coregistration.ampcor_backend import prepare_ampcor_native
...
def test_explicit_native_without_candidate_fails_closed() -> None:
    ...
    from faninsar.processing.coregistration import estimate_patch_amplitude_shift
...
def test_product_passes_centered_secondary_to_energy_candidate() -> None:
    ...
    torch = pytest.importorskip("torch")
    from faninsar.processing.coregistration import offsets
