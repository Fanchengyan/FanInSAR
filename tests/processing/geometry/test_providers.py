...
from faninsar.processing.geometry.providers import (
    GLO30_PC,
    GLO90_PC,
    PC_STAC_URL,
    PcStacSource,
...
def test_pc_materializes_signed_cog_directly_to_projected_grid(
    ...
    monkeypatch.setattr(
        "faninsar.processing.geometry.providers.fetch_asset", fake_fetch
    )
    from faninsar.processing.geometry import GridSpec, materialize_source
